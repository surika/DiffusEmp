...
from diffusemp.utils import dist_util, logger
from diffusemp.utils.fp16_util import (
    make_master_params,
...
from diffusemp.utils.nn import update_ema
from diffusemp.step_sample import LossAwareSampler, UniformSampler
...
class TrainLoop:
    ...
    def forward_only(self, batch, cond):
        with th.no_grad():
            ...
            for i in range(0, batch.shape[0], self.microbatch):
                ...
                if last_batch or not self.use_ddp: #use_ddp=True if cuda
    ...
    def forward_backward(self, batch, cond):
        ...
        for i in range(0, batch.shape[0], self.microbatch):
            ...
            if last_batch or not self.use_ddp: # use_ddp=True if use cuda
                losses = compute_losses()
            else:
                with self.ddp_model.no_sync():
                    losses = compute_losses()
