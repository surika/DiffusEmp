...
class TransformerNetModel(nn.Module):
    ...
    def forward(self, x, timesteps, visible_mask=None): diffusiox_t
        """
        ...
        if visible_mask is not None:
            visible_mask = visible_mask.unsqueeze(dim=1)

        input_trans_hidden_states = self.input_transformers(emb_inputs, attention_mask = visible_mask).last_hidden_state
        # input_trans_hidden_states size:(bsz, seqlen, 768)
